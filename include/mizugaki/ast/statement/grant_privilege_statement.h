...
/**
 * @brief grants resource privileges to users.
 * @note `12.2 <grant privilege statement>`
 */
class grant_privilege_statement : public statement {

    using super = statement;

public:
    /// @brief the node kind of this.
    static constexpr node_kind_type tag = node_kind_type::grant_privilege_statement;
     ...
     */
    explicit grant_privilege_statement(
     ...
     */
    explicit grant_privilege_statement(::takatori::util::clone_tag_t, grant_privilege_statement const& other);

    /**
     * @brief creates a new instance.
     * @param other the move source
     */
    explicit grant_privilege_statement(::takatori::util::clone_tag_t, grant_privilege_statement&& other);

    [[nodiscard]] grant_privilege_statement* clone() const& override;
    [[nodiscard]] grant_privilege_statement* clone() && override;
     ...
     */
    friend bool operator==(grant_privilege_statement const& a, grant_privilege_statement const& b) noexcept;
