...
/**
 * @brief represents a octet string type.
 */
class octet_string final : public type {
...
public:
     ...
     */
    explicit octet_string(::takatori::util::clone_tag_t, octet_string const& other);

    /**
     * @brief creates a new instance.
     * @param other the move source
     */
    explicit octet_string(::takatori::util::clone_tag_t, octet_string&& other);

    [[nodiscard]] octet_string* clone() const& override;
    [[nodiscard]] octet_string* clone() && override;
    ...
    /**
     * @brief returns the octet string length.
     * @return the available number of bytes in the string
     * @return empty if the string length is not defined
     * @return flexible_length if this octet string has flexible length
     */
     ...
     * @return false otherwise
     */
    friend bool operator==(octet_string const& a, octet_string const& b) noexcept;
