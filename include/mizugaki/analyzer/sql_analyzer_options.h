...
public:
    ...
    /**
     * @brief the default value of whether or not to consider small integer literals (~2^63-1) as smaller data types.
    ...
    /**
     * @brief returns whether or not to consider small integer literals (~2^63-1) as smaller data types.
