...
identifier
    : REGULAR_IDENTIFIER[t]
        {
            $$ = driver.node<ast::name::simple>(driver.parse_regular_identifier($t), @$);
        }
...
contextual_identifier
    : ADA[t] { $$ = driver.node<ast::name::simple>(driver.parse_regular_identifier($t), @$); }
    | C[t] { $$ = driver.node<ast::name::simple>(driver.parse_regular_identifier($t), @$); }
    | COBOL[t] { $$ = driver.node<ast::name::simple>(driver.parse_regular_identifier($t), @$); }
    | FORTRAN[t] { $$ = driver.node<ast::name::simple>(driver.parse_regular_identifier($t), @$); }
    | G[t] { $$ = driver.node<ast::name::simple>(driver.parse_regular_identifier($t), @$); }
    | K[t] { $$ = driver.node<ast::name::simple>(driver.parse_regular_identifier($t), @$); }
    | M[t] { $$ = driver.node<ast::name::simple>(driver.parse_regular_identifier($t), @$); }
    | MUMPS[t] { $$ = driver.node<ast::name::simple>(driver.parse_regular_identifier($t), @$); }
    | PASCAL[t] { $$ = driver.node<ast::name::simple>(driver.parse_regular_identifier($t), @$); }
    | PLI[t] { $$ = driver.node<ast::name::simple>(driver.parse_regular_identifier($t), @$); }
    ;
