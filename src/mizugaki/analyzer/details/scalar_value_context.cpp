...
std::shared_ptr<::takatori::type::data>& scalar_value_context::type() noexcept {
    return type_;
}

std::shared_ptr<::takatori::type::data> const& scalar_value_context::type() const noexcept {
    return type_;
}

std::shared_ptr<::takatori::value::data>& scalar_value_context::default_value() noexcept {
    return default_value_;
}

std::shared_ptr<::takatori::value::data> const& scalar_value_context::default_value() const noexcept {
    return default_value_;
}
