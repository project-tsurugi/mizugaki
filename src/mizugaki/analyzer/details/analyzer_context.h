...
public:
    ...
    [[nodiscard]] ::takatori::util::finalizer initialize(
            ...
            ::takatori::util::optional_ptr<::yugawara::variable::provider const> host_variables = {});
    ...
    [[nodiscard]] ::takatori::util::optional_ptr<::yugawara::variable::provider const> host_variables() const noexcept {
...
private:
    ...
    ::takatori::util::optional_ptr<::yugawara::variable::provider const> host_variables_ {};
