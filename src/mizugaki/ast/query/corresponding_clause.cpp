...
corresponding_clause::corresponding_clause(::takatori::util::clone_tag_t, corresponding_clause const& other) :
    corresponding_clause {
...
corresponding_clause::corresponding_clause(::takatori::util::clone_tag_t, corresponding_clause&& other) :
    corresponding_clause {
...
std::vector<std::unique_ptr<name::simple>>& corresponding_clause::column_names() noexcept {
    return *column_names_;
}

std::vector<std::unique_ptr<name::simple>> const& corresponding_clause::column_names() const noexcept {
    return *column_names_;
}
