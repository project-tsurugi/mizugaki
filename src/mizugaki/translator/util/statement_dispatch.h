...
auto dispatch(Callback&& callback, ::shakujo::model::statement::Statement const& node, Args&&... args) {
    ...
    switch (node.kind()) {
        ...
        case ddl::CreateIndexStatement::tag: return polymorphic_callback<ddl::CreateIndexStatement>(std::forward<Callback>(callback), unsafe_downcast<ddl::CreateIndexStatement>(node), std::forward<Args>(args)...);
        ...
        case ddl::DropIndexStatement::tag: return polymorphic_callback<ddl::DropIndexStatement>(std::forward<Callback>(callback), unsafe_downcast<ddl::DropIndexStatement>(node), std::forward<Args>(args)...);
