...
class analyze_name_test : public ::testing::Test {
public:
...
protected:
    ...
    std::shared_ptr<::yugawara::storage::configurable_provider> storages_ = std::make_shared<::yugawara::storage::configurable_provider>(); // NOLINT
    std::shared_ptr<::yugawara::schema::configurable_provider> schemas_ = std::make_shared<::yugawara::schema::configurable_provider>(); // NOLINT
